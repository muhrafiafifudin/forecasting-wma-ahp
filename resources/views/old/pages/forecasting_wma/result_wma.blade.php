                ...
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Hasil Peramalan WMA</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card m-b-20">
                        <div class="card-body">
                            ...
                            <h4 class="mt-0 header-title">Hasil Peramalan WMA</h4>
                            <p class="text-muted m-b-30">
                                Menampilkan semua data hasil peramalan wma yang tersedia.
                            </p>
